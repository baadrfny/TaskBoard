        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 relative">
                ...
                <div class="absolute top-6 right-6 flex gap-3">
                    ...
                    <!-- Archive Button -->
                    <form action="{{ route('tasks.destroy', $task->id) }}" method="POST" onsubmit="return confirm('Archiver cette tâche ?')" class="inline">
                        @csrf @method('DELETE')
                        <button type="submit" class="text-yellow-400 hover:text-yellow-500">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8l4 4 4-4m6 5l-3-3m0 0l-3 3m3-3v12" />
                            </svg>
                        </button>
                    </form>
                    <!-- Hard Delete Button -->
